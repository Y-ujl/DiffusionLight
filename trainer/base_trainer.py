...
class BaseTrainer(ABC):
    ...
    def __init__(
        ...
        self.critic = None
        '''yjl 4.21'''
        #self.similarity_threshold = Registry.mapping['trainer_mapping']['setting'].param['similarity_threshold']
    ...
    def create(self):
        ...
        :return: None
        '''
        self.create_world()             # 创建世界
        self.create_agents()            # 创建智能体
        self.create_metrics()           # 创建评估指标
        self.create_env()               # 创建模拟环境 获取obs, rewards, dones, infos
